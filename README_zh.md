# 
<p align="center">
<img src="./TopitToo/Assets.xcassets/AppIcon.appiconset/icon_128x128@2x.png" width="200" height="200" />
...
### 使用:
- TopitToo 支持将任意多个窗口强制置顶显示, 并允许用户自由移动、缩放或与被置顶窗口进行自由交互.  
- 用法极其简单, 用户只需启动 TopitToo 并选择需要置顶显示的窗口, 然后点击 "立即置顶" 即可将其置顶. 

## 常见问题
**1. 为什么 TopitToo 会请求屏幕录制和辅助功能权限?**  
> TopitToo 需要使用屏幕录制和辅助功能权限来捕获并控制任意窗口, 如果不授予此权限将无法正常工作.  

**2. TopitToo 会很耗电吗?**  
> TopitToo 使用 ScreenCapture Kit 来进行低功耗窗口捕获. 但如果用户同时置顶太多窗口, 仍然可能出现明显的电量消耗.  
